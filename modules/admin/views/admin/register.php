...
<body>
	...
	<div class="register-container">
		...
		<form novalidate="novalidate" action="/admin/admin/register"
			...
			<div>
				<input name="Code" class="Code" placeholder="输入手机验证码"
					autocomplete="off" id="number" type="text">
			</div>
			<div>
	...
	<ul style="visibility: visible;" class="speed" id="supersized">
		<li style="visibility: visible; opacity: 1;" class="slide-0 prevslide">
			<a target="_blank"> <img
